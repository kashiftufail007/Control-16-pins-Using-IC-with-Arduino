// Control  16 leds or 16 pins with arduino using IC (24pins)
...
void loop() {
      //Simple loops works 16 times and ON/OFF leds one by one
  for(int i=0; i<16; i++)
  {
 ...
 Serial.println("===============");//after one round of 16 leds // display this line on Serial 
